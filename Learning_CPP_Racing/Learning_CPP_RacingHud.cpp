...
ALearning_CPP_RacingHud::ALearning_CPP_RacingHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ALearning_CPP_RacingHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		ALearning_CPP_RacingPawn* Vehicle = Cast<ALearning_CPP_RacingPawn>(GetOwningPawn());
