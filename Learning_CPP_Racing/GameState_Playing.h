...
public:
	...
	UFUNCTION(Server,Reliable,WithValidation)void Server_IncreasePointsOfPlayer(int32 PlayerStateID, int8 Amount = 1);
	void Server_IncreasePointsOfPlayer_Implementation(int32 PlayerStateID, int8 Amount );
	bool Server_IncreasePointsOfPlayer_Validate(int32 PlayerStateID, int8 Amount );
